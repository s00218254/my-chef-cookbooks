...
if node["neutron"]["plugin"] == "ml2"
  template "/etc/neutron/plugins/ml2/ml2_conf.ini" do
    ...
    variables(
      ...
      "db_password" => neutron_info["db"]["password"],
      "db_name" => neutron_info["db"]["name"],
      "ml2_firewall_driver" => node["neutron"]["ovs"]["firewall_driver"],
      "ml2_type_drivers" => node["neutron"]["ml2"]["type_drivers"],
      "ml2_mechanism_drivers" => node["neutron"]["ml2"]["mechanism_drivers"],
      "ml2_tenant_network_types" => node["neutron"]["ml2"]["tenant_network_types"],
      "ml2_network_vlan_ranges" => node["neutron"]["ml2"]["network_vlan_ranges"],
      "ml2_tunnel_id_ranges" => node["neutron"]["ml2"]["tunnel_id_ranges"],
	  "ml2_vni_ranges" => node["neutron"]["ml2"]["vni_ranges"],
	  "ml2_vxlan_group" => node["neutron"]["ml2"]["vxlan_group"],
	  "ml2_debug" => node["neutron"]["debug"],
      "ml2_verbose" => node["neutron"]["verbose"] 
    )
  end
end
